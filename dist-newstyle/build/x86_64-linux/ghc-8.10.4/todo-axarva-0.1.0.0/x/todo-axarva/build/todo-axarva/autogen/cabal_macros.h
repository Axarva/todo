...
/* package todo-axarva-0.1.0.0 */
#ifndef VERSION_todo_axarva
#define VERSION_todo_axarva "0.1.0.0"
#endif /* VERSION_todo_axarva */
#ifndef MIN_VERSION_todo_axarva
#define MIN_VERSION_todo_axarva(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_todo_axarva */
...
#define CURRENT_COMPONENT_ID "todo-axarva-0.1.0.0-inplace-todo-axarva"
